...
class Server(object):
    ...
    def _test_(self, t, selected_clients):
        dataset = 'TinyImageNet' if self.args.dataset == 'tinyimagenet' else self.args.dataset
        # test
        ...
        wandb_dict = {f'loss/{dataset}': self.train_perf[t][0]}
        ...
        wandb_dict[f'acc/{dataset}'] = self.test_perf[t][1] * 100
